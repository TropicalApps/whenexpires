            ...
            <div data-name="component">
                <article>
                    ...
                    <div class="pa4-l n-mt-6">
                        <form class="mw7 center pa4 br2-ns ba b--black-10 bg-white shadow-4" method="POST" id="domain-form">
                            <fieldset class="cf bn ma0 pa0">
                                <div class="cf">
                                    <label class="clip" for="email-address">Domain</label>
                                    <input required class="f6 f5-l input-reset bn fl black-80 bg-near-white pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns" placeholder="yourdomain.com" type="text" name="domain" value="" id="domain" v-model="domain">
